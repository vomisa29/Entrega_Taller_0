...
public class ConsolaOlimpicos
{
	...
	{
		String atleta_buscar = input("Ingrese el atleta que desea analizar");
		Atleta info = null;
		Pais pais_atleta = null;
		String retorno_pais = "";
		
		if (calculadora.buscarAtleta(atleta_buscar) != null) {
			info = calculadora.buscarAtleta(atleta_buscar);
		    pais_atleta = info.darPais();
		    retorno_pais = pais_atleta.darNombre();
		    System.out.println("El pais de " + atleta_buscar + " es " + retorno_pais);
		}
		else
		{
			System.out.println("\nEl atleta no se pudo encontrar. Intentelo de nuevo");
		}
	}
